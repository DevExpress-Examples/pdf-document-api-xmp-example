...
Namespace XmpMetadataExamples
    ...
    Friend Class Program
        ...
        Shared Sub Main(ByVal args As String())
            Call EmbedLoadedMetadata()
            Call EmbedEditedMetadata()
            Call EmbedGeneratedMetadata()
        End Sub
        ...
        Private Shared Function GenerateXmpMetadata() As XmpDocument
            Dim document As XmpDocument = New XmpDocument()
            ' Register namespaces:
        ...
        Private Shared Sub ExportSchemas()
            Dim metadata As XmpDocument = New XmpDocument()
